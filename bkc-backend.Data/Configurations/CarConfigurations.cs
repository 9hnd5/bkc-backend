...
namespace bkc_backend.Data.Configurations
{
    public class CarConfigurations : IEntityTypeConfiguration<Car>
    {
        public void Configure(EntityTypeBuilder<Car> builder)
        {
            ...
            builder.Property<string>(c => c.TotalSeat);
            builder.Property<string>(c => c.AvailableSeat);
            builder.Property<string>(c => c.Status);
            builder.Property<string>(c => c.BookingDate);
            builder.Property<string>(c => c.BuId);
            builder.Property<string>(c => c.BuName);
            builder.Property<string>(c => c.BookerId);
            builder.Property<string>(c => c.DriverId);
            builder.HasData(
                    new Car()
                    {
                        Id = "1001",
